...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { description: @manufacturer.description, email: @manufacturer.email, name: @manufacturer.name, website: @manufacturer.website } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { description: @manufacturer.description, email: @manufacturer.email, name: @manufacturer.name, website: @manufacturer.website } }
