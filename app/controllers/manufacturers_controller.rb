class ManufacturersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @manufacturer.save
        format.html { recover_flow_or_redirect_to manufacturer_url(@manufacturer), notice: "Manufacturer was successfully created." }
  ...
  def manufacturer_params
    params.require(:manufacturer).permit(:name, :description, :website, :email)
  end
end
